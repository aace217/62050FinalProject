...
set_false_path -setup -from [get_cells {bpm_buf[0]}]
set_false_path -setup -from [get_cells {bpm_buf[1]}]
set_false_path -setup -from [get_cells {bpm_buf[2]}]
set_false_path -setup -from [get_cells {bpm_buf[3]}]
set_false_path -setup -from [get_cells {bpm_buf[4]}]
set_false_path -setup -from [get_cells {bpm_buf[5]}]
set_false_path -setup -from [get_cells {bpm_buf[6]}]
set_false_path -setup -from [get_cells {bpm_buf[7]}]
set_false_path -setup -from [get_cells {bpm_buf_reg[0]}]
set_false_path -setup -from [get_cells {bpm_buf_reg[1]}]
set_false_path -setup -from [get_cells {bpm_buf_reg[2]}]
set_false_path -setup -from [get_cells {bpm_buf_reg[3]}]
set_false_path -setup -from [get_cells {bpm_buf_reg[4]}]
set_false_path -setup -from [get_cells {bpm_buf_reg[5]}]
set_false_path -setup -from [get_cells {bpm_buf_reg[6]}]
set_false_path -setup -from [get_cells {bpm_buf_reg[7]}]
